...
import { FINAL_STEP } from '@shared/components/PlanReport/PlanReportFilters/PlanReportFilters';
...
export const FiltersModal = ({ isOpen, onClose, schoolYearStartDate }: Props) => {
