...
const getCommonFilters = (rawFilters: OpportunityReportFilters) => {
...
export const useOpportunityReportFilters = () => {
  const { filters, appliedFilters, ...rest } = useReportFilters<OpportunityReportFilters>();
