...
AdminTracksListItemDetailsModal.propTypes = {
  isOpen: PropTypes.bool,
  onClose: PropTypes.func,
  trackId: PropTypes.string,
};

function AdminTracksListItemDetailsModal({ isOpen, onClose, trackId }) {
  const { t } = useTranslation();

  return (
    <SharedModal isOpen={isOpen} onDismiss={onClose}>
      <SharedModal.Header>
        <SharedModal.Heading>{t('admin.tracks.detailsHeading')}</SharedModal.Heading>
      </SharedModal.Header>
      <SharedModal.Body>
          ...
          {({ track }) => {
            ...
            return (
              <>
                ...
                <p data-testid='modal-track-name'>{track.displayName}</p>
...
export default AdminTracksListItemDetailsModal;
