...
function AdminTasksPresentationBuilderTemplate4ProductChoicePreviewImage({
  imageContentId,
  content,
}: Props) {
...
export default AdminTasksPresentationBuilderTemplate4ProductChoicePreviewImage;
