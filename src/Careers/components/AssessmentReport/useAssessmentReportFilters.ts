...
const getCommonFilters = (rawFilters: AssessmentReportFilters) => {
...
export const useAssessmentReportFilters = () => {
  const { filters, appliedFilters, ...rest } = useReportFilters<AssessmentReportFilters>();
