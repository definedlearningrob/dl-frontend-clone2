...
import { useCareerExplorationReportFilters } from './useCareerExplorationReportFilters';
...
export const CareerExplorationFiltersModal = ({ isOpen, onClose }: Props) => {
  const { t } = useTranslation();
  const { resetFilters, submitFilters } = useCareerExplorationReportFilters();
