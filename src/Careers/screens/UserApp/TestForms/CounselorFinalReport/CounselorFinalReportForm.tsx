...
import {
  ...
  counselorFinalReportFormSchema,
  counselorFinalReportFormUiSchema,
} from './CounselorFinalReportSchemas';
import styles from './CounselorFinalReport.module.sass';
...
export const CounselorFinalReportForm = (props: Props) => {
  const { studentUuid } = useParams<{ studentUuid: string }>();
  const { t } = useTranslation();
  const formRef = useRef(null);
  const { saveForm, extraErrors, isSaving } = useFormSave<typeof counselorFinalReportFormSchema>({
  ...
  return (
    <div className={styles.formWrapper}>
      ...
      <JsonForm
        ...
        schema={counselorFinalReportFormSchema}
        uiSchema={counselorFinalReportFormUiSchema}
        onChange={(data) => {
